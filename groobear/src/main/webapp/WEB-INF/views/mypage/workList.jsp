	...
	<main>
    	<div class="mainInner">
	        <div class="button-group">
	        	...
	        	<a href="${pageContext.request.contextPath}/mypage/modify" class="custom-button">나의 정보 확인</a>
		    </div>
			<form action="">
...
$(function(){
	var chartDom = document.getElementById('workClock');
	var myChart = echarts.init(chartDom);
	var option;
