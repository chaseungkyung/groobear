...
<div class="iconHeader-right">
	<div class="iconHeader-right-inner">
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath}/project/projectTask/${projIdx}"><img alt="" src="${pageContext.request.contextPath}/dist/images/project/gantt-chart.png">업무</a></li>
			<li><a href="${pageContext.request.contextPath}/project/projectPostList/${projIdx}"><img alt="" src="${pageContext.request.contextPath}/dist/images/project/board.png">게시판</a></li>
